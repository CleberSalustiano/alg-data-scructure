...
Some algorithms and data structures are crucial for a software engineer, trying to solve and implement these problems are very interesting as they make them think outside the box.
So I'm going to do some algorithms and data structures for fun, or when I have nothing to do.
